...
public class GeckoModel<T extends GeckoEntity> extends HierarchicalModel<T> {
    ...
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(TutorialMod.MOD_ID, "kaupengecko"), "main");
    ...
    public void setupAnim(GeckoEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        animateWalk(GeckoAnimations.ANIM_GECKO_WALK, limbSwing, limbSwingAmount, 2F, 2.5F);
        animate(GeckoEntity.idleAnimationState, GeckoAnimations.ANIM_GECKO_IDLE, ageInTicks, 1F);
    }
